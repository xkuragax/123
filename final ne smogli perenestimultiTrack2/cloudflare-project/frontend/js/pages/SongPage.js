...
import MultitrackPlayer from '../components/MultitrackPlayer.js';

export default {
  components: { MultitrackPlayer },
  props: ['songId'],
  ...
  template: `
      ...
      <div v-else class="container mx-auto px-4 py-3 max-w-4xl">
        ...
        <div class="space-y-4">
          ...
          <div class="space-y-3">
            ...
            <!-- Action Buttons -->
            <div v-if="song.lyrics || song.tabs_url || song.stems_url" class="space-y-3">
    ...
    <div class="md:hidden min-h-screen bg-black flex items-center justify-center p-2">
      ...
      <div v-else-if="error" class="text-center">
        <div class="text-red-500 text-xs px-4" style="font-family: 'Courier New', monospace;">{{ error }}</div>
      </div>
  ...
  setup(props) {
    ...
    const loadSongData = async () => {
      try {
        ...
        const data = await api.getSong(props.songId);
    ...
    return { loading, error, song, album, tracks, showLyrics, stemsLoading };
  }
};
